...
Zed can open a directory that is a [linked Git worktree](https://git-scm.com/docs/git-worktree) like any other project; status, branches, and diffs work as usual.
Zed does not create, switch, or delete worktrees on your behalf — manage them with `git worktree` from your shell.
